...
public class DateTimeTest {
	...
	public static void main(String[] args) {
		...
		// int 번위 벗어나면 overflow 입니다. long 변환 필요 
	...
	1)java.util.Date 클래스  2)java.util.Calendar 클래스	-> old 클랫랫
	...
	*/
	...
	//새 버전 클래스는 날짜 사이의 간격 계산 클래스가 있습니다.
	Period between = Period.between(mybirth,currentDate);
	System.out.println("내가 태어난지" + between.getYears() +" 년(year)");
	System.out.println("	" + between.getMonths()+" 개월(month)");
	System.out.println("	" + between.getDays()+" 일(days)");
	
	System.out.println("내가 태어난지 :" + ChronoUnit.DAYS.between(mybirth, currentDate));
