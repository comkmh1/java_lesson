...
//char 형은 2바이트 정수를 저장하여 문자(모양)를 표현한다.
		...
		carr2 = "hello hi goodbye".toCharArray(); //String 문자열 객체를 char 배열로 호호호
		...
		String temp ="String.valueOf : " + String.valueOf(carr2); // char[]배열을 문자열로 변환합니다.
																// String 객체의 toCharArray()메소드와 반대
		//참고 : String.valueOf  메소드는 여러가지 매개변수 형식을 다룹니니(method overloading)
