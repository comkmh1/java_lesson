...
public class C47_MemberTest {
	...
	public static void main(String[] args) {
		...
		ArrayList<Member> list = new ArrayList<>();	//list에 저장되는 것은 객체의 참조값
		
		list.add(new Member("모모",27));	//새로운 객체가 생성 되고 참조값을 리스트에 추가 
		...
		System.out.println("list 요소 중 참조 객체 age 필드 값이 25이하만 출력");
