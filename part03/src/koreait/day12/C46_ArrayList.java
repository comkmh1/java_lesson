...
public class C46_ArrayList {
	...
	public static void main(String[] args) {
		int[] datas = {45,23,7,21,19,11,44};	// 배열은 선언할 때 배열의 크기를 정합니다.
												// 배열은 기본형 타입 int, double, long ... 또는 참조형 타입
		
		ArrayList<Integer> list = new ArrayList<>();
				// ArrayList는 크기가 동적입니다.
				// 데이터 타입은 모두 참조형입니다.		기본형은 래퍼클래스를 사용합니다.
				// <E> 는 제너릭 타입이라고 부릅니다. 데이터 요소의 타입을 정합니다.
		...
		System.out.println("2.두번째 ArrayList<Stirng> 출력");
		System.out.println(name_list);
		System.out.println("리스트 크기 : " + name_list.size());	// 데이터 없을 때 0 

		System.out.println("3.세번째 특정위치에 데이터 추가");
		list.add(1,23);		//(인덱스위치, 추가될 값)
		System.out.println("add(1,23) 결과 : " + list);
		name_list.add(2,"신비");
		System.out.println("add(2,\"신비\") 결과 : " + name_list);
	
		System.out.println("4.네번째 인덱스 값으로 데이터 가져오기");
		...
		// '신비' 요소가 여러개일 때 리스트 lastIndexOf 메소드로 마지막 일치 요소를 찾을 수 있습니다.
		
		System.out.println("\n8. contains 메소드");
		System.out.println("'나나'가 리스트에 있는가가" + name_list.contains("나나"));
		System.out.println("'다현'가 리스트에 있는가가" + name_list.contains("다현"));
